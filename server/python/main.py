...
def main():
    ...
    #     f.write(sys.argv[1])
    # samples = deserialize_samples('{"sampleStringsInfo":[{"markerType":"Control characters","markedStrings":["sdas"],"markerInfo":{"nul":false,"startOfHeading":true,"startOfText":true,"endOfText":true,"endOfTransmission":true,"enquiry":true,"acknowledge":false,"bell":false,"backspace":false,"horizontalTab":true,"newLine":false,"verticalTab":false,"formFeed":true,"carriageReturn":true,"shiftOut":true,"shiftIn":false,"dataLinkEscape":false,"deviceControlOne":false,"deviceControlTwo":true,"deviceControlThree":false,"deviceControlFour":false,"negativeAcknowledge":false,"synchronousIdle":true,"endOfTransBlock":false,"cancel":false,"endOfMedium":false,"substitute":true,"escape":true,"fileSeparator":true,"groupSeparator":false,"recordSeparator":false,"unitSeparator":false,"matchAllExceptSelectedOnes":false},"repeatInfo":{"repeat":"1"}}],"generalRegexInfo":{"startRegexMatchAt":"Anywhere","endRegexMatchAt":"Anywhere","regexTarget":"Java"},"generateMethod":"samplesAndSemantics"}')
