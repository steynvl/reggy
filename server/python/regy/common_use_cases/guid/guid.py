from regy.common_use_cases.guid.options_to_re import braces_to_re, case_to_re
...
class Guid:
    ...
    def _calculate_regex(self):
        case_char_class = case_to_re[self._target][self._info['guidCase']]

        hyphens_in = self._info['hyphensIn']
        ...
        braces_around = self._info['bracesAround']
