...
national_id_to_re = {
    ...
    Target.JAVA: {
        ...
        'South african ID number'                    : '(((\\\\d{2}((0[13578]|1[02])(0[1-9]|[12]\\\\d|3[01])|(0[13-9]|1[012])(0[1-9]|[12]\\\\d|30)|02(0[1-9]|1\\\\d|2[0-8])))|([02468][048]|[13579][26])0229))(( |-)(\\\\d{4})( |-)(\\\\d{3})|(\\\\d{7}))',
    ...
    Target.POSIX: {
        ...
        'Chinese National Identification Card Number': '',
        'Croatian Master Citizen Number'             : '',
        'Danish Civil Registration Number'           : '',
        'Finnish Social Security Number'             : '',
        'Indian Permanent Account Number'            : '',
        'Indian Vehicle License Plate Number'        : '',
